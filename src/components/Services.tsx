  ...
  const services = [
    {
      ...
      description:
        "Curated safe space to reconnect with your truth and move forward with clarity and courage.",
      features: [
    ...
    },
    {
      ...
      description:
        "30 days 1:1 guided journey to soften survival, build self-trust, and create aligned, lasting shifts.",
      features: [
    ...
    },
    {
      ...
      description:
        "Interactive group sessions to spark insight, clarity, and embodied transformation",
      features: [
    ...
    },
    {
      ...
      description:
        "A safe, intimate space to be heard, without fixing, analyzing, or performing.",
      features: [
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 md:mb-16 scroll-animate">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto px-4">
            Choose the path that resonates with where you are in your becoming
            journey
          </p>
        </div>
                      ...
                      <ul className="space-y-2 md:space-y-3">
                        {service.features.map((feature, featureIndex) => (
                          ...
                          >
                            ...
                            <span className="text-muted-foreground group-hover/item:text-foreground transition-smooth text-xs md:text-sm lg:text-base leading-relaxed">
                              {feature}
                            </span>
                          </li>
                        ))}
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (service.cta === "Join the next workshop") {
                            window.open(
                              "https://in.bookmyshow.com/events/the-mirror-room/ET00454396?webview=true",
                              "_blank"
                            );
                          } else if (
                            service.cta === "Join the listening community"
                          ) {
                            window.open(
                              "https://chat.whatsapp.com/F6QVIlGqcvcJwT8jUssrZp?mode=ac_t",
                              "_blank"
                            );
                          } else if (service.cta === "Take your space") {
                            window.open(
                              "https://rzp.io/rzp/coaching-aarushi",
                              "_blank"
                            );
                          } else {
                            window.open(
                              "https://rzp.io/rzp/barebecomingprogram",
                              "_blank"
                            );
                          }
                        }}
