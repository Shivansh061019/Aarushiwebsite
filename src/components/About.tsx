            ...
            >
              <div className="space-y-6 md:space-y-8 text-base md:text-lg text-muted-foreground leading-relaxed">
                <p className="text-lg md:text-xl">
                  ...
                  intense, too much for the world to understand. There were days
                  I almost believed the voices around me that maybe I was the
                  ...
                  else?" But healing has a way of humbling you and waking you
                  up. It taught me that while what happened to me wasn't my
                  fault, what I do with my life next, is my responsibility.{" "}
                  <span className="font-semibold text-primary">
                    And that is power.
                  </span>
                  Through years of inner work and burning through my illusions,
                  I met the truth, not always easy, but always freeing.
                </p>

                <p className="font-semibold text-primary text-lg md:text-xl lg:text-2xl leading-relaxed">
                  And now, I've become who I once needed: A calm, honest light
                  in someone else's dark. Not to fix, but to remind, you were
                  never broken.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto px-4">
              ...
              <div className="bg-background/80 backdrop-blur-sm p-6 md:p-8 rounded-2xl shadow-gentle border border-border/50 text-left">
                ...
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                  ...
                  and resilient and live a fulfilling aligned life. To rise
                  beyond conditioning, past noises, patterns, because life is
                  not what happened to you, it is about who you choose to
                  become.
                </p>
              </div>
            </div>
