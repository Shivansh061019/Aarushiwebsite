...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      <Navigation onBookCallClick={handleBookCallClick} />
      <Hero />
      <SectionDivider imageUrl="/lovable-uploads/05553acf-2df7-4342-81f2-40c1ce7e62f0.png" />
      <ProblemStatement />
      <SectionDivider
        imageUrl="/lovable-uploads/89b12470-47ec-409b-840a-7be12985a93f.png"
        reverse
      />
      <Solution />
      ...
      <About />
      <SectionDivider
        imageUrl="/lovable-uploads/09bde273-ceda-4afd-ad02-6d07fdabbead.png"
        reverse
      />
      <Services />
